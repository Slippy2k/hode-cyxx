...
static uint8_t _lar1_unkData[96] = {
...
void Game::postScreenUpdate_lar1_screen18() {
	...
	if ((_lar1_unkData[0x59] & 0x40) == 0 && (_lar1_unkData[0x59] & 0x80) != 0) {
		if ((_lar1_unkData[0x4D] & 1) == 0) {
			_lar1_unkData[0x4D] |= 1;
		}
	}
	if ((_lar1_unkData[0x4D] & 0x40) == 0 && (_lar1_unkData[0xD4] & 0x80) != 0) {
		if ((_lar1_unkData[0x59] & 1) == 0) {
			_lar1_unkData[0x59] |= 1;
		}
	}
}
