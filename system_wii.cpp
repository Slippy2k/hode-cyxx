...
void System_Wii::processEvents() {
	...
	static const struct {
		...
		{ PAD_BUTTON_UP | (WPAD_BUTTON_UP << 16), SYS_INP_UP },
		{ PAD_BUTTON_RIGHT | (WPAD_BUTTON_RIGHT << 16), SYS_INP_RIGHT },
		{ PAD_BUTTON_DOWN | (WPAD_BUTTON_DOWN << 16), SYS_INP_DOWN },
		{ PAD_BUTTON_LEFT | (WPAD_BUTTON_LEFT << 16), SYS_INP_LEFT },
